import { Tasty } from '@/scrapers/Tasty';
...
describe('Tasty', () => {
  ...
  beforeEach(() => {
    html = readFileSync('tests/test_data/tasty.co/tasty_1.test.html', 'utf8');
    scraper = new Tasty(html, 'tasty.co/recipe/test');
  });

  it('should have correct host', () => {
    expect(Tasty.host()).toBe('tasty.co');
  });
