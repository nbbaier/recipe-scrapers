import { AllRecipes } from '../../src/scrapers/AllRecipes';
...
describe('AllRecipes', () => {
  ...
  beforeEach(() => {
    html = readFileSync('tests/test_data/allrecipes.html', 'utf8');
    scraper = new AllRecipes(html, 'allrecipes.com/recipe/test');
  });
